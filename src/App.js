...
/*Essentially what it does is take a number, 
format it into the string format
 and create the space separators for the thousand mark*/
...
const percentClickHandler=()=>{
  ...
  let res= calc.res? parseFloat(removeSpaces(calc.num.res)):0;
